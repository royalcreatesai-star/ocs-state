...
- **Delivery:** direct account access (primary); engineer = execution, Royal = engagement mgr + reviewer; assessment read-only, Build separate engagement; clean outcome = $1,500 Clearance Report.
